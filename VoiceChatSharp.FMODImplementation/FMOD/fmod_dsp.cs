...
public struct DSP_STATE_FUNCTIONS
{
    ...
    {
        get { return Marshal.PtrToStructure<VoiceChatSharp.FMODImplementation.FMOD.DSP_STATE_DFT_FUNCTIONS>(dft_internal); }
    }
    public DSP_STATE_PAN_FUNCTIONS pan
    {
        get { return Marshal.PtrToStructure<VoiceChatSharp.FMODImplementation.FMOD.DSP_STATE_PAN_FUNCTIONS>(pan_internal); }
    }
}
...
public struct DSP_STATE
{
    ...
    {
        get { return Marshal.PtrToStructure<VoiceChatSharp.FMODImplementation.FMOD.DSP_STATE_FUNCTIONS>(functions_internal); }
    }
}
